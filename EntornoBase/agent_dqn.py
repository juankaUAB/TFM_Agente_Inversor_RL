...
model = DQN("MlpPolicy", env, verbose = 1, exploration_fraction=0.2, batch_size=64, learning_rate=lr_schedule, learning_starts=7500, buffer_size=75000, tensorboard_log="./dqn_stocktrading_tensorboard/", replay_buffer_class=ReplayBuffer)
...
model.learn(total_timesteps=1_000_000, log_interval=5, callback=callback, progress_bar=True, tb_log_name = "DQN_1M_lrDecayente")
